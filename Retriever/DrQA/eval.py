...
dataset = "/home/giuseppe/Scrivania/HLT_Project/Retriver/DrQA/tools/QA_<P>.sqlite3"
model = "/home/giuseppe/Scrivania/HLT_Project/dati/tfidf/gnq/tf-idf/articles_clean-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz"
doc_db = "/home/giuseppe/Scrivania/HLT_Project/dati/tfidf/gnq/data_base/articles_clean2.sqlite3"
tokenizer = "regexp"
n_docs= 2
num_workers = 4
match = "string"
...
questions = []
answers = []
connection = sqlite3.connect(dataset, check_same_thread=False)
...
######################################################
risposta = "Pom Klementieff"
doc_titles = closest_docs[3][0]
